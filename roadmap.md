...
- [x] Add Rowan Archer to the relationship chart with directional relationships, portrait, gold-brown emblem, animated title, and overflow-safe tooltips.
- [x] Add the supplied pink emblem behind Ashley’s name and the supplied gold emblem behind Rowan’s name using GitHub-safe assets.
- [x] Place Rowan directly below Ashley and shift Ashley’s hat slightly farther right.
...
- [ ] Close the gap between Rowan's relationship lines and his circle (desktop and mobile).
- [ ] Sweep for GitHub Pages bugs (real asset binaries, typecheck) and verify end-to-end.
