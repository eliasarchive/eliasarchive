          ...
          <>
            ...
            {scene === manorScenes.length - 1 && (
              <>
                ...
                <WindowRainCanvas maskSrc={manorRoomPaneMask} className="cinematic-bedroom" layer="droplets" zIndex={2} />
...
function DeskScene({ onEnter, entering }: { onEnter: () => void; entering: boolean }) {
  return (
    <section className="desk-scene-enter relative h-dvh overflow-hidden bg-ink">
      ...
      <WindowRainCanvas maskSrc={manorRoomPaneMask} layer="droplets" zIndex={2} className={`bedroom-terminal-view ${entering ? "terminal-zoom" : ""}`} />
