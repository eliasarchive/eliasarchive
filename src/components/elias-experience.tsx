...
export function EliasExperience() {
  ...
  useEffect(() => {
    ...
    const sources = [manorEntrance, manorStair, manorGallery, manorStudy, manorRoomInterior, manorRoomPaneMask, welcomeRoseField, welcomeFrameSquare, eliasBotanicalFrame, eliasRose, eliasBowing, nanasePortrait, nanaseClawLogo, roseEmblem, archiveRoseField];
